...
public abstract class Ranger extends SomeHero {
    ...
    public Ranger(int attack, int defense, int shots, int minDamage, int maxDamage, float hp, int maxHp, int speed, String name, int team, int xCoordinate, int yCoordinate) {
